...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size):
        ...
        self.proj = nn.Linear(head_size * num_heads, n_features)
        self.dropout = nn.Dropout(dropout)
...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.token_embedding_table = nn.Embedding(vocab_size, n_features)
        self.position_embedding_table = nn.Embedding(block_size, n_features)
        self.blocks = nn.Sequential(*[Block(n_features, n_head=n_heads) for _ in range(n_layers)])
